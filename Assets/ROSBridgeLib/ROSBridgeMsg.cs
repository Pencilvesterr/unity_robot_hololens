...
public class ROSBridgeMsg  {
    ...
    public static string Subscribe(string messageTopic, string messageType, string QueueLength)
    {
        return "{\"op\": \"subscribe\", \"topic\": \"" + messageTopic + "\", \"type\": \"" + messageType + "\", \"queue_length\": \"" + QueueLength + "\"}";
    }
